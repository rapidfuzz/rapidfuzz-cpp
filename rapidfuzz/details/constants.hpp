...
#define rapidfuzz_CPP11_OR_GREATER_ ( rapidfuzz_CPLUSPLUS >= 201103L )
...
#elif defined(rapidfuzz_USE_STD_OPTIONAL)
  # define rapidfuzz_USES_STD_OPTIONAL  true
#elif rapidfuzz_CPP17_OR_GREATER && defined(__has_include ) && __has_include(<optional>)
  # define rapidfuzz_USES_STD_OPTIONAL  true
#else
  # define rapidfuzz_USES_STD_OPTIONAL  false
#endif
