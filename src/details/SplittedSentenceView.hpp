...
public:
   ...
   public:
     explicit const_iterator(typename string_view_vec<CharT>::const_iterator iter)
       : words_iter(iter){}
...
public:
  SplittedSentenceView(string_view_vec<CharT> sentence)
  ...
  const_iterator cbegin() const { return const_iterator(m_sentence.begin()); }
  const_iterator cend() const { return const_iterator(m_sentence.end()); }
